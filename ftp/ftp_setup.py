...
"""
        ...
        try:
            ...
            print("✓ vsftpd configuration written")
            return True
            
        except IOError as e:
            print(f"✗ Failed to write vsftpd config: {e}")
            return False
    ...
    def configure_ssh(self) -> bool:
        ...
        try:
            ...
            if 'Subsystem sftp' not in content:
                ...
                print("✓ SFTP subsystem enabled")
            else:
                print("✓ SFTP subsystem already enabled")
    ...
    def setup_firewall(self) -> bool:
        ...
        try:
            ...
            for port, description in ports:
                ...
                print(f"✓ Allowed {description}: {port}")
    ...
    def setup_fail2ban(self) -> bool:
        ...
        if not self.security.get('fail2ban_enabled', False):
            print("\n⚠ fail2ban disabled in config, skipping")
            return True
...
"""
        ...
        try:
            ...
            print("✓ fail2ban configured and started")
            return True
            
        except (IOError, subprocess.CalledProcessError) as e:
            print(f"✗ Failed to configure fail2ban: {e}")
            return False
    
    def create_ftp_root(self) -> bool:
        """Create FTP root directory."""
        print("\n📁 Creating FTP root directory...")
        ...
        try:
            ...
            print(f"✓ FTP root created at {ftp_root}")
            return True
            
        except OSError as e:
            print(f"✗ Failed to create FTP root: {e}")
            return False
    ...
    def verify_setup(self) -> bool:
        ...
        for service, description in checks:
            try:
                ...
                print(f"✗ Could not check {description}")
                all_ok = False
